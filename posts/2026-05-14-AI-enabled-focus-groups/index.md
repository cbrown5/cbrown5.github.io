...
The selling point is they are much cheaper, faster and than human focus groups, and you can easily go back and ask them more questions. The downsides are obvious: do they really represent what a focus group would tell you? 

The marketing of the tools is also excellent. The results are presented as if they are from real focus groups, with sample sizes for different groups of people. Ours had 'n=5' for each group. 
...
For example, most large language models perform better at coding and reasoning tasks with one off instructions rather than engaging in conversation. 
...
The recent drug overdose [lawsuit against OpenAI](https://arstechnica.com/tech-policy/2026/05/will-i-be-ok-teen-died-after-chatgpt-pushed-deadly-mix-of-drugs-lawsuit-says/) is a particularly horrifying example of sycophantic behaviour. 

The chat logs have been made public as part of that case and include conflicting advice to seek medical help, but also advice like "here's how to optimize your trip for comfort, introspection and enjoyment." (and doesn't the "here's how to optimize..." sound just like chatGPT speak!)
...
You can imagine the disastrous results they could lead to in public policy, for instance. The AI-enabled focus groups are an echo chamber for making hard decisions. 
...
Its not clear to me that you would then need an AI 'focus group'. Why not just write down your ideas, what you think, then get any old reasoning AI to work through possible perspectives of different personas. That would give you a nice list of potential perspectives to explore with real thinking in your human brain. 

But I wouldn't treat AI output like its human data and assign it sample sizes as if its representative of a human population. Sample size is also not much of a limitation with AI. Asking an AI something 50 times versus 5 would cost at most $1-$2 extra. 
